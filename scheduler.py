...
def run_daily_report():
    ...
    try:
        ...
        try:
            ...
            tg_sent = send_telegram_alert_sync(final_report, analysis)
        except Exception as e:
            print(f"❌ Telegram error: {e}")
            tg_sent = False

        # ── STEP 7: Log the result
        log_result(email_sent, wa_sent, tg_sent, analysis)
...
def log_result(email_sent, wa_sent, tg_sent, analysis):
    """
    ...
    try:
        ...
        with open(log_file, "a") as f:
            ...
            f.write(f"Telegram Sent: {tg_sent}\n")
